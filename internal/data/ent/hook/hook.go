...
// The AbsenceTypeFunc type is an adapter to allow the use of ordinary
// function as AbsenceType mutator.
type AbsenceTypeFunc func(context.Context, *ent.AbsenceTypeMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f AbsenceTypeFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.AbsenceTypeMutation); ok {
		return f(ctx, mv)
	}
...
// The LeaveAllowanceFunc type is an adapter to allow the use of ordinary
// function as LeaveAllowance mutator.
type LeaveAllowanceFunc func(context.Context, *ent.LeaveAllowanceMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f LeaveAllowanceFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.LeaveAllowanceMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.LeaveAllowanceMutation", m)
}
